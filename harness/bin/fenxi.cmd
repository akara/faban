...
set PROG=%FENXI_SCRIPTS/process
...
%JAVA% -Xmx756m -cp %CLASSPATH% -Dderby.storage.pageReservedSpace=0 -Dderby.language.logQueryPlan=true -Dderby.storage.rowLocking=false -Dfenxi.basedir=%FENXI_HOME% -Dfenxi.profile=default_profile -Djava.awt.headless=true -Dsun.java2d.pmoffscreen=false org.fenxi.cmd.process.ProcessRun %*
