...
<xsl:stylesheet version="1.0"
    ...
    <xsl:param name="CSS-managed-alerts" select="'false'"/>
    ...
    <xsl:variable name="default-css" select="'forms/styles/styles.css'"/>
    <xsl:variable name="mozilla-css" select="'forms/styles/mozilla-xforms.css'"/>
    <xsl:variable name="ie-css" select="'forms/styles/ie-xforms.css'"/>
    ...
    <xsl:template match="xhtml:head">
        <head>
            ...
            <xsl:if test="$uses-dates">
                ...
                <script type="text/javascript" src="scripts/jscalendar-0.9.6/calendar.js"></script>
            </xsl:if>
    ...
    <xsl:template match="xhtml:body">
        ...
        <body>
            ...
            <a href="jsp/forms.jsp">
                <img src="forms/images/chiba50t.gif" border="0" vspace="5" alt="Chiba Logo" width="113" height="39" id="chiba-logo"/>
            </a>
            <table border="0">
                <tr>
                    <td width="33"></td>
                    <td>
                        <xsl:element name="form">
                            ...
                            <SCRIPT LANGUAGE="JavaScript">
                                document.
                                <xsl:value-of select="$form-id"/>.value = 'enabled';
                            </SCRIPT>
                            <xsl:apply-templates/>
                        </xsl:element>
                    </td>
